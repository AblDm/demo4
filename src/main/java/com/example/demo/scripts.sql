--Вывести записи сортированные по УБЫВАНИЮ стоимости (DESC)
SELECT * FROM expense ORDER BY amount DESC;
--
--Вывести записи сортированные по ВОЗРАСТАНИЮ стоимости (ASC)
...
-- Вывести категории где записей в категории больше чем 1 шт.
SELECT category, COUNT(*) FROM expense GROUP BY category HAVING COUNT(*) > 1